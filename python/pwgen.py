...
alphabet_default = string.letters + string.digits
...
def pwgen(alphabet, easy, length=16):
    for i in xrange(t_height - 3):
        for j in xrange(t_width / (length + 1)):
            if easy:
                print easy_to_type_randomstring(alphabet, length),
            else:
                print randomstring(alphabet, length),
        print
